...
const jsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Start after you are comfortable with core DSA patterns. Read one framework article, then practise one case study per week out loud (URL shortener, rate limiter, news feed, chat). DSA Solutions publishes ten in-depth system design articles at dsasolved.com/system-design, including SQL vs NoSQL, load balancing, and how LeetCode patterns map to real infrastructure.',
      },
    },
  ],
}
  ...
  },
  {
    ...
    a: (
      <>
        ...
        <p className="mt-2">
          Our <Link href="/system-design" className="text-violet-600 dark:text-violet-400 hover:underline">System Design section</Link> has ten in-depth articles written for developers coming from LeetCode practice — frameworks, case studies (URL shortener, rate limiter, news feed, chat), and fundamentals (caching, SQL vs NoSQL, load balancing, API design).
        </p>
      </>
    ),
  },
