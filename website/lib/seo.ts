...
export function buildSystemDesignHubSchema(
  ...
  return {
    ...
    description:
      `${articleCount} practical system design articles for coding interview prep: frameworks, URL shortener, rate limiter, caching, news feed, chat, payments, Uber, web crawler, notifications, file storage, CAP theorem, sharding, Kafka, SQL vs NoSQL, load balancing, and API design.`,
