...
export function buildSystemDesignHubSchema(
  ...
  return {
    ...
    description:
      `${articleCount} practical system design articles for coding interview prep: frameworks, URL shortener, rate limiter, caching, news feed, chat, payments, Uber, Gmail, CDN, Twitch, S3 object storage, DNS, OAuth authentication, webhooks, service discovery, feature flags, A/B testing, Bloom filters, distributed counters, MapReduce, distributed logging, ad click aggregator, Google Calendar, recommendations, stock trading, DoorDash, Stack Overflow, web crawler, Netflix, search engine, ticketing, Redis, e-commerce, notifications, file storage, CAP theorem, sharding, Kafka, SQL vs NoSQL, load balancing, and API design.`,
