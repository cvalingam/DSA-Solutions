...
article.sections.push(
  { type: 'h2', text: 'A practical study plan' },
  {
    ...
    items: [
      ...
      'Read [caching](/system-design/caching-fundamentals-for-interviews), [SQL vs NoSQL](/system-design/sql-vs-nosql-for-interviews), [load balancing](/system-design/load-balancing-and-scaling), [API design](/system-design/api-design-rest-interviews), [unique IDs](/system-design/design-unique-id-generator), and [message queues](/system-design/message-queues-async-processing) for fundamentals.',
      'Case studies: [notifications](/system-design/design-notification-system), [file storage](/system-design/design-file-storage-dropbox), [typeahead](/system-design/design-typeahead-autocomplete).',
